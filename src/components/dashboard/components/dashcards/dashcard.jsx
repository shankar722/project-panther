...
const Dashcard = ({index, data = {title: '', desc: '', blValue: '', blLabel: '', brValue: '', brLabel: '', value: '', valueColor: '', unit: '', perc: '', percDirection: 'top'}}) => {
  ...
  <div 
    ...
    {position === 'bottom' && alignment === 'right' && <p className="perc m-0 p-0 d-flex align-items-center" style={{color: percDirection === 'top' ? '#00985b' : '#ff0000', visibility: !index ? 'hidden' : ''}}>
  ...
  return (
    <Card className='custom-card p-3'>
      ...
      <div className="d-flex align-items-center justify-content-between mt-2">
        {titleDescContainer('bottom', 'left')}
        {titleDescContainer('bottom', 'right')}
      </div>
    </Card>
  )
}
